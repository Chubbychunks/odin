double FOI_part(double I, double N, double beta, double R, double fc_comm, double fP_comm, double n_comm, double eP, double ec) {
  
  return I * (1 -
              pow(1 -                       beta * R, n_comm * (1 - fc_comm) * (1 - fP_comm)) *
              pow(1 - (1 - ec) *            beta * R, n_comm *      fc_comm  * (1 - fP_comm)) *
              pow(1 -            (1 - eP) * beta * R, n_comm * (1 - fc_comm) *      fP_comm ) *
              pow(1 - (1 - ec) * (1 - eP) * beta * R, n_comm *      fc_comm  *      fP_comm ));
}

double compute_lambda(double c_comm, double p_comm, double S0, double S1a, double S1b, double S1c, double I01, double I11, double I02, double I03, double I04, double I05, double I22, double I23, double I24, double I25, double I32, double I33, double I34, double I35, double I42, double I43, double I44, double I45, double N, double beta, double R, double fc_comm, double fP_comm, double n_comm, double eP, double ec) {
