...
best_set = list(fraction_F = 0.52, 
                rate_enter_sexual_pop = 0.3,
                SC_to_200_349 = 0.4444,
                fc_y_comm = matrix(
                  rep(c(0.5, 0.55, 0.88, 0.99), 9), ncol = 9),
                gamma22 = rep(0.999, 9)
                )

parameters = lhs_parameters(1, set_pars = best_set)[[1]]

parameters$fc_y_comm
